-- =============================================
-- Script Solo para TABLAS Y DATOS (Sin crear BD)
-- Proyecto: MVCDemoC
-- Base de Datos: InvoicesDB
-- =============================================

-- IMPORTANTE: Ejecuta esto si la base de datos InvoicesDB ya existe
-- Este script NO crea la base de datos, solo las tablas y datos
...
IF OBJECT_ID('dbo.invoice_details', 'U') IS NOT NULL DROP TABLE invoice_details;
