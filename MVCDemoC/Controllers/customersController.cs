...
namespace MVCDemoC.Controllers
{
    public class customersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "customer_id,name,address,phone,active")] customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "customer_id,name,address,phone,active")] customers customers)
        {
            if (ModelState.IsValid)
            {
